...
const rewrites = {
  ...
  "/api/meta/oauth/start": "/api/admin?resource=meta/oauth/start",
  "/api/meta/oauth/callback": "/api/admin?resource=meta/oauth/callback",
  "/api/meta/status": "/api/admin?resource=meta/status",
  "/api/meta/publish-test-facebook": "/api/admin?resource=meta/publish-test-facebook",
  "/api/meta/publish-test-instagram": "/api/admin?resource=meta/publish-test-instagram",
