...
function routineTasks() {
  const taskDefinitions = [
    {
      type: "keyword_search",
      title: "Busca 3 keywords del dia",
      description: "Abre cada busqueda, mira resultados recientes y detecta conversaciones con preguntas reales.",
      priority: "high",
      difficulty: "easy",
      estimatedMinutes: 10,
      steps: [
        "Abre TikTok, Instagram y YouTube desde las keywords sugeridas.",
        "Mira 5-10 resultados por keyword y prioriza videos con comentarios de gente buscando vivienda.",
        "Apunta 1 idea de contenido o pregunta repetida por cada keyword."
      ],
      doneWhen: "Has encontrado 3 conversaciones o formatos que podrian convertirse en comentario, hook o video propio."
    },
    {
      type: "save_videos",
      title: "Guarda 5 videos con buen hook",
      description: "Guarda videos utiles como inspiracion y anota que parte del formato se puede adaptar.",
      priority: "high",
      difficulty: "medium",
      estimatedMinutes: 20,
      steps: [
        "Guarda videos que enganchen en los 3 primeros segundos.",
        "Anota el hook, el tema y por que funciona: debate, checklist, sorpresa, comparativa o historia.",
        "No copies el contenido: decide como adaptar el formato a InmoRadar."
      ],
      doneWhen: "Tienes 5 referencias guardadas y al menos 1 adaptacion posible para InmoRadar."
    },
    {
      type: "comment",
      title: "Deja 10 comentarios utiles",
      description: "Copia, adapta y publica comentarios manualmente solo donde aporten criterio real.",
      priority: "high",
      difficulty: "medium",
      estimatedMinutes: 25,
      steps: [
        "Lee el video y 3-5 comentarios destacados antes de responder.",
    ...
    },
    {
      ...
      title: "Sigue 5 cuentas relevantes",
      description: "Revisa cada perfil antes de seguirlo y prioriza cuentas donde puedas aportar valor.",
      priority: "medium",
      difficulty: "easy",
      estimatedMinutes: 12,
      steps: [
    ...
    {
      type: "hooks",
      title: "Anota 3 hooks adaptables",
