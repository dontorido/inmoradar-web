...
function buildScenes({ topic, topicConfig, city, durationSeconds, tone, audience, cta }) {
  ...
  const commonVisual = city
    ? `video vertical de una busqueda inmobiliaria en ${city}, estetica InmoRadar, interfaz moderna, vivienda, mapa y datos`
    : "video vertical de una busqueda inmobiliaria en Espana, estetica InmoRadar, interfaz moderna, vivienda, mapa y datos";
  ...
  return [
    {
      ...
      voiceover: hook,
      on_screen_text: hook,
      visual_prompt: `${commonVisual}. Primer plano de movil con anuncio inmobiliario, fondo limpio, alto contraste, sin texto pequeno.`,
      motion: "zoom lento hacia el movil, entrada suave del titular",
      ai_instruction: `Genera una escena de apertura para ${audienceText}; estilo ${toneConfig.style}.`
    },
    {
      id: "scene-02-data",
      ...timing[1],
      ...
      visual_prompt: `${commonVisual}. Tarjeta de datos con precio, metros cuadrados y calculo por m2. Sin marcas de portales.`,
    ...
    },
    {
      ...
      visual_prompt: `${commonVisual}. Mapa abstracto con zona urbana, transporte y senales de entorno, estilo editorial sobrio.`,
    ...
    },
    {
      ...
      visual_prompt: `${commonVisual}. Comparativa visual entre anuncio, referencia y semaforo de decision.`,
    ...
    },
    {
      ...
      visual_prompt: `${commonVisual}. Cierre limpio con interfaz de InmoRadar, boton de accion y firma de marca.`,
...
function buildGlobalAiPrompt(project) {
  ...
  return [
    ...
    "Estilo visual: InmoRadar, moderno, inmobiliario, claro, premium, sin ruido visual.",
...
function generateSocialVideoProject(input = {}) {
  ...
  const scenes = buildScenes({ topic, topicConfig, city, durationSeconds, tone, audience, cta });
  ...
  const project = {
    ...
    music_direction: "base electronica suave, ritmo rapido pero sobrio, sin tapar voz",
    render_contract: {
      preview_html: true,
      storyboard: true,
      thumbnail: true,
