...
const META_ORGANIC_TEST_IMAGE_URL = "https://www.inmoradar.app/assets/inmoradar-brand-mark.jpg";
...
function organicTestImageUrl(env = process.env) {
  ...
  return META_ORGANIC_TEST_IMAGE_URL;
}
...
function validateMetaOrganicEnv(env = process.env, { target = "instagram" } = {}) {
  ...
  return {
    ...
    instagram_publish_account_id: config.instagramPublishAccountId || null
  };
}
