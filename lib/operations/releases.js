    ...
    extension: [
      {
        ...
        configured:
          ...
          (configured(env.CHROME_WEBSTORE_ACCESS_TOKEN) || configured(env.CHROME_WEBSTORE_REFRESH_TOKEN)),
        purpose: "Subir paquete y enviar a publicación mediante API oficial."
      },
      {
        id: "edge",
