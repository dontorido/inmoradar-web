...
function usefulLinks() {
  return `<section class="seo-section" id="enlaces-utiles">
    ...
    <div class="seo-link-bento">
      ...
      <a href="${CHROME_WEBSTORE_URL}" target="_blank" rel="noopener noreferrer"><span>↗</span><span>Instalar InmoRadar</span><small>CHROME WEB STORE</small></a>
    </div>
  </section>`;
}
...
function cta(city) {
  return `<section class="seo-final-cta" data-city-specific="true">
    ...
    <div class="seo-final-actions">
      <button class="seo-button seo-button-primary" type="button" data-install-button data-install-source="seo_city_guide_cta">EMPIEZA A DESCUBRIR INFORMACIÓN RELEVANTE</button>
