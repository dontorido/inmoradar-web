...
const { geoLevelLabel, sourceName } = require("./priceCity");
...
function usefulLinks() {
  return `<section class="seo-section" id="enlaces-utiles">
    ...
    <div class="seo-link-bento">
      ...
      <a href="/premium"><span>↗</span><span>Instalar InmoRadar Premium</span><small>INMORADAR.APP/PREMIUM</small></a>
    </div>
  </section>`;
}
...
function cta(city) {
  return `<section class="seo-final-cta" data-city-specific="true">
    ...
    <div class="seo-final-actions">
      <a class="seo-button seo-button-primary" href="/premium">INSTALAR INMORADAR</a>
